...
public class Dashboard extends JFrame implements ActionListener {
    ...
    JButton addPersonalDetails, viewPersonalDetails, updatePersonalDetails, checkpackages, bookpackages,
            viewpackages, viewhotels, destinations, bookhotel, viewBookedhotel, payments, calculators,
            notepad, about, deletePersonalDetails;
...
//        setBounds(0, 0, 1600, 1000);
        ...
        checkpackages = new JButton("Cheak Package");
        ...
        viewpackages.setBounds(0, 294, 300, 50);
        ...
        viewhotels = new JButton("View Hotals");
        ...
        bookhotel = new JButton("Book Hotal");
        ...
        viewBookedhotel = new JButton("View Booked Hotal");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == addPersonalDetails) {
            ...
            new BookHotal(username);
        } else if (ae.getSource() == viewBookedhotel) {
            new ViewHotal(username);
