...
public class CheckHotals extends JFrame implements Runnable {
    ...
    public void run() {
        String[] text = new String[] {"JW Marriott Hotal", "Madarin Oriental Hotal",  "Four Seasons Hotal", 
            "Raddisson Blue Hotal", "Classio Hotal", "The Bay Club Hotal", "Breeze Blow Hotal", "The Taj Hotal",
            "Happy Morning Hotal", "River View Hotal"};
